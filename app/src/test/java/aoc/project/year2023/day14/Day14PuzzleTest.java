...
public class Day14PuzzleTest {
    ...
    public void doPart1_givenExample1_assertNotNull(){
        List<String> lines = AocUtil.readFile("app/src/test/resources/puzzleInputs/year2023/day14Example1.txt");
        assertNotNull(lines);
        assertEquals(10, lines.size());
        assertEquals(136, day14Puzzle.doPart1(lines)); 
    }
    ...
    public void doPart2_givenChallenge_assertNotNull(){
        ...
        assertNotNull(lines);
        assertEquals(10, lines.size());
        assertEquals(64, day14Puzzle.doPart2(lines));  
    }
