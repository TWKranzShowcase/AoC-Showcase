...
public class Day13PuzzleTest {
    ...
    public void doPart1_givenExample1_assertNotNull(){
        List<String> lines = AocUtil.readFile("app/src/test/resources/puzzleInputs/year2024/day13Example1.txt");
        assertNotNull(lines);
        assertEquals(15, lines.size());
        assertEquals(480, day13Puzzle.doPart1(lines)); 
    }
    ...
    public void doPart2_givenChallenge_assertNotNull(){
        ...
        assertEquals(-1, day13Puzzle.doPart2(lines));  
    }
