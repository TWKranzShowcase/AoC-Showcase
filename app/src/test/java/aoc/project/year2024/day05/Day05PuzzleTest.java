...
public class Day05PuzzleTest {
    ...
    public void doPart1_givenExample1_assertNotNull(){
        List<String> lines = AocUtil.readFile("app/src/test/resources/puzzleInputs/year2024/day05Example1.txt");
        assertNotNull(lines);
        assertEquals(28, lines.size());
        assertEquals(143, day05Puzzle.doPart1(lines)); 
    }
    ...
    public void doPart2_givenChallenge_assertNotNull(){
        ...
        assertNotNull(lines);
        assertEquals(28, lines.size());
        assertEquals(123, day05Puzzle.doPart2(lines));  
    }
